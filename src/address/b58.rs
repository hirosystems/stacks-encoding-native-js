...
mod tests {
    ...
    fn test_base58_encode() {
        ...
        // Addresses
        let addr = decode_hex("00f8917303bfa8ef24f292e8fa1419b20460ba064d").unwrap();
        assert_eq!(
    ...
    fn test_base58_decode() {
        ...
        // Addresses
        assert_eq!(
            from_check("1PfJpZsjreyVrqeoAfabrRwwjQyoSQMmHH").unwrap(),
            decode_hex("00f8917303bfa8ef24f292e8fa1419b20460ba064d")
                .unwrap()
                .as_ref()
        )
    }
